---
title: "Experiment 2026-05-29 — 双菌梯度稀释 qPCR 分析"
author: "Chun-Hui Gao"
date: "2026-05-29"
format: html
editor: source
...
```{r}
#| message: false
raw_file = "data-raw/optimization-tm/2026-05-29 195141.txt"
...
```{r}
#| label: fig-amplification-curve-260529
#| fig-cap: "单菌稀释系列扩增曲线"
...
```{r}
#| label: fig-mc-single-species-260529
#| fig-cap: "单菌稀释系列的熔解曲线"
...
```{r}
#| label: fig-mc-gradient-matrix-260529
#| fig-cap: "双菌梯度矩阵熔解曲线"
mc_df = mc2tbl(mc)
mc_df_matrix = mc_df |>
  dplyr::filter(well_position %in% gradient_matrix_well) |>
  mutate(across(c(label_E, label_P),
                 ~ log2(.x) |> as_factor() |> fct_rev()))
