...
well_meta <- setup_raw %>%
  ...
  distinct(WellPos, SampleName) %>%
  mutate(Label = ifelse(nzchar(SampleName), paste0(WellPos, " (", SampleName, ")"), WellPos))
...
# 也可以按样本名批量取孔位，例如:
selected_wells <- wells_for_sample("Sample 2")
...
# 5. 需要的话保存为图片
# ----------------------------------------------------------------------------
ggsave("Sample_2_amplification_selected.png",   p_amp,        width = 9, height = 6, dpi = 300, bg = "white")
ggsave("Sample_2_melt_derivative_selected.png", p_melt_deriv, width = 9, height = 6, dpi = 300, bg = "white")
ggsave("Sample_2_melt_raw_selected.png",        p_melt_raw,   width = 9, height = 6, dpi = 300, bg = "white")
ggsave("Sample_2_amplification_overview_log.png", p_amp_overview, width = 9, height = 6, dpi = 300, bg = "white")
```